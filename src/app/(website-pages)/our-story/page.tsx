            ...
            <main className="relative">
                ...
                <section className="bg-white text-black py-32 border-t border-stone-100">
                    <div className="flex flex-col items-center justify-center px-6 text-center">
                        ...
                        <a href="https://reserve.dreamplaypianos.com" className="group inline-flex items-center gap-3 bg-accent text-white px-10 py-5 text-lg font-medium rounded-full hover:scale-105 transition-transform shadow-lg shadow-accent/20">
                            Pre-Order Now

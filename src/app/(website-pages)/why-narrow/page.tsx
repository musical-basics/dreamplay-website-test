      ...
      <main className="main-wrapper">
        ...
        <section className="dp-section-wrapper" style={{ padding: "0 0 8rem" }}>
          ...
          <div className="dp-content-container dp-center">
            ...
            <a href="https://crowdfund.dreamplaypianos.com" className="group inline-flex items-center gap-3 bg-white text-black px-8 py-4 text-lg font-bold rounded-full hover:scale-105 transition-transform">

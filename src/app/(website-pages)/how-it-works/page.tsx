...
const DonutChart = ({ percent, label, theme = "light" }: { percent: number; label: string; theme?: "light" | "dark" }) => {
    ...
    // Red/Green regardless of light/dark theme for consistency
    const filledColor = "#ff2d55";
    const emptyColor = "#34c759";
    const innerBg = theme === "light" ? "#f5f5f5" : "#050505";
    ...
    return (
        <div className="min-h-screen selection:bg-white/20">
            ...
            <main className="flex flex-col items-center">
                ...
                {/* ═══ SECTION 3: THE HIDDEN BARRIER — LIGHT ═══ */}
                <section className="w-full bg-neutral-50 text-black py-12 md:py-24 px-4 flex justify-center">
                    <div className="w-full max-w-[80rem] p-6 md:p-16">
                        <div className="text-center mb-20">
                            <p className="font-sans text-[10px] uppercase tracking-[0.3em] text-neutral-500 mb-4">The Data</p>
                            <h2 className="font-serif text-4xl md:text-5xl tracking-tight leading-tight mb-6 text-black">The Hidden Barrier</h2>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 mb-20">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="text-center mb-10">
                                    <div className="font-serif text-6xl font-bold mb-3 text-[#ff2d55]">87%</div>
                                    <div className="font-sans text-xl font-medium text-neutral-600 mb-3">of females</div>
                                    <p className="font-sans text-sm text-neutral-500 max-w-[280px] mx-auto leading-relaxed">
                                        Have hand spans smaller than the 8.5 inch minimum that standard keyboards expect.
                                    </p>
                                </div>
                                <div className="bg-white border border-neutral-200 rounded-none p-10 w-full max-w-sm flex flex-col items-center hover:border-neutral-400 transition-all duration-500">
                                    <DonutChart percent={87} label="" theme="light" />
                                    <div className="flex gap-8 text-xs font-medium text-neutral-500 mt-8">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="text-center mb-10">
                                    <div className="font-serif text-6xl font-bold mb-3 text-[#ff2d55]">24%</div>
                                    <div className="font-sans text-xl font-medium text-neutral-600 mb-3">of males</div>
                                    <p className="font-sans text-sm text-neutral-500 max-w-[280px] mx-auto leading-relaxed">
                        ...
                        <div className="border-t border-neutral-200 pt-16 mt-8 grid md:grid-cols-2 gap-12 text-center md:text-left">
                            <div className="px-4">
                                <div className="font-serif text-6xl font-bold mb-3 text-black">8.5"</div>
                                <div className="font-sans text-[10px] uppercase tracking-[0.3em] text-neutral-500 mb-4">The Threshold</div>
                            ...
                            <div className="px-4">
                                <div className="font-serif text-6xl font-bold mb-3 text-black">25 to 30%</div>
                                <div className="font-sans text-[10px] uppercase tracking-[0.3em] text-neutral-500 mb-4">Larger Reach Required</div>
                                <p className="font-sans text-base leading-relaxed text-neutral-600">
                ...
                {/* ═══ SECTION 4: PUBLISHED RESEARCH — LIGHT ═══ */}
                <section className="w-full bg-white text-black py-12 md:py-24 px-4 flex justify-center">
                    <div className="w-full max-w-[80rem] p-6 md:p-16">
                        <div className="text-center mb-16">
                            <p className="font-sans text-[10px] uppercase tracking-[0.3em] text-neutral-500 mb-4">Evidence</p>
                            <h2 className="font-serif text-4xl tracking-tight leading-tight mb-4 text-black">Published Research</h2>
                            <p className="font-sans text-sm md:text-base leading-relaxed text-neutral-600">Decades of peer reviewed research explain why standard keyboards hold most pianists back.</p>
                        </div>

                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            {/* Study 1 */}
                            <div className="bg-neutral-50 border border-neutral-200 rounded-none p-10 flex flex-col hover:border-neutral-400 transition-all duration-300">
                                <h3 className="font-serif text-2xl font-bold text-black mb-3">Hand size and performance related injuries</h3>
                                <div className="font-sans text-[10px] uppercase tracking-[0.3em] text-neutral-500 mb-6">Applied Ergonomics, 2021</div>
                                <p className="font-sans text-base leading-relaxed text-neutral-600 mb-10 flex-grow">
                                ...
                                <a href="https://www.sciencedirect.com/science/article/abs/pii/S0003687021001654" target="_blank" className="group inline-flex items-center justify-center gap-2 bg-black text-white px-8 py-4 font-sans text-xs uppercase tracking-widest transition-colors hover:bg-neutral-800 w-fit">
                            ...
                            {/* Study 2 */}
                            <div className="bg-neutral-50 border border-neutral-200 rounded-none p-10 flex flex-col hover:border-neutral-400 transition-all duration-300">
                                <h3 className="font-serif text-2xl font-bold text-black mb-3">Gender differences and career impact</h3>
                                <div className="font-sans text-[10px] uppercase tracking-[0.3em] text-neutral-500 mb-6">Susan Tomes</div>
                                <p className="font-sans text-base leading-relaxed text-neutral-600 mb-10 flex-grow">
                                ...
                                <a href="https://www.susantomes.com/blog/hand-size-gender-differences-pianists-acclaim/" target="_blank" className="group inline-flex items-center justify-center gap-2 bg-black text-white px-8 py-4 font-sans text-xs uppercase tracking-widest transition-colors hover:bg-neutral-800 w-fit">

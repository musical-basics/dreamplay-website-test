        ...
        <div className="bg-black min-h-screen text-white selection:bg-blue-500/30">
            ...
            <main className="pt-24 flex flex-col items-center">
                ...
                <section className="py-32 text-center border-t border-white/10 w-full bg-[#080a0f]">
                    ...
                    <a href="https://reserve.dreamplaypianos.com" className="inline-block bg-white text-black px-10 py-5 rounded-full font-bold text-xl hover:bg-gray-200 hover:scale-105 transition-all shadow-xl shadow-white/10">

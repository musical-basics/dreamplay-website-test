        ...
        <section ref={sectionRef} className="w-full bg-black text-white pt-28 pb-16 md:pt-40 md:pb-36">
            <div className="max-w-5xl mx-auto px-4 md:px-6">
                ...
                <div className={`text-center mb-10 md:mb-16 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                    ...
                    <h2 className="mt-4 font-serif text-2xl leading-tight text-white md:text-4xl lg:text-5xl text-balance font-semibold">The Hidden Barrier</h2>
                </div>
                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-6 md:mb-8 transition-all duration-700 delay-200 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className="flex flex-col items-center text-center relative">
                        <div className="border border-white/10 p-6 md:p-8 relative overflow-hidden">
                            ...
                            <div className="relative w-[180px] h-[180px] md:w-[220px] md:h-[220px] mb-4 md:mb-6">
                                <svg viewBox="0 0 220 220" className="w-full h-full transform -rotate-90">
                                    ...
                                    {/* Comfortable arc (subtle neutral) */}
                                    <circle cx="110" cy="110" r={r} fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="18"
                                    ...
                                    {/* Affected arc (gold) */}
                                    <circle cx="110" cy="110" r={r} fill="none" stroke="#c4a44a" strokeWidth="18"
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    <span className="font-serif text-4xl md:text-5xl font-bold tracking-tight text-white">87%</span>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="border border-white/10 p-6 md:p-8 relative overflow-hidden">
                            ...
                            <div className="relative w-[180px] h-[180px] md:w-[220px] md:h-[220px] mb-4 md:mb-6">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    <span className="font-serif text-4xl md:text-5xl font-bold tracking-tight text-white">24%</span>
                                </div>
                            </div>
                ...
                <div className={`border-t border-white/10 pt-10 md:pt-16 grid md:grid-cols-2 gap-8 md:gap-12 text-center md:text-left transition-all duration-700 delay-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                    <div className="relative">
                        <div className="absolute top-0 left-0 md:left-0 w-12 h-px bg-[#c4a44a]" />
                        <div className="pt-6">
                            <div className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2 md:mb-3">8.5&quot;</div>
                    ...
                    <div className="relative">
                        <div className="absolute top-0 left-0 md:left-0 w-12 h-px bg-[#c4a44a]" />
                        <div className="pt-6">
                            <div className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2 md:mb-3">25–30%</div>

                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className={`mt-2 font-sans text-sm leading-relaxed ${selected === "self" ? "text-white/70" : "text-neutral-500"}`}>
                        ...
                        <div className={`flex items-center gap-2 font-sans text-xs uppercase tracking-wider ${selected === "self" ? "text-white/60" : "text-neutral-400"}`}>
                            Explore
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className={`mt-2 font-sans text-sm leading-relaxed ${selected === "child" ? "text-white/70" : "text-neutral-500"}`}>
                                Build proper technique from day one with keys sized for smaller hands. Light-up LED keys make practice fun and engaging.
                            </p>
                        </div>
                        <div className={`flex items-center gap-2 font-sans text-xs uppercase tracking-wider ${selected === "child" ? "text-white/60" : "text-neutral-400"}`}>
                            Explore
                            <ArrowRight className="h-3 w-3 transition-transform group-hover:translate-x-1" />
                        </div>
                    </button>
